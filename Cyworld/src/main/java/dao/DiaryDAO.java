...
public class DiaryDAO{
	...
	//글 삭제
	public int delete( int DiaryContentRef ) {
		int res = sqlSession.delete("cw.diary_delete", DiaryContentRef);
		return res;
	}
	
	//수정을 위한 게시글 한 건 조회
	public DiaryVO selectOne( int DiaryContentRef ) {
		DiaryVO vo = sqlSession.selectOne("cw.diary_one", DiaryContentRef);
		return vo;
	}
